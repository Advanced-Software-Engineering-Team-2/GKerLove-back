...
public class MeetService {
    ...
    public List<UserDto> getUserList(User currentUser, String gender, Integer minAge, Integer maxAge, String city, String institute) {
        ...
        query.addCriteria(Criteria.where("username").ne(currentUser.getUsername()));
...
//        Query query1 = new Query(Criteria.where("username").is(currentUser.getUsername()));
...
//        return newuserlist;
    ...
    public void MeetingNotlove(String fromusername, String tousername) {
        ...
        if (touser != null) {
            ...
            if (touser_nomeetinglist == null) touser_nomeetinglist = new ArrayList<>();
        }
        ...
        if (fromuser != null) {
            ...
            if (fromuser_nomeetinglist == null) fromuser_nomeetinglist = new ArrayList<>();
        }
